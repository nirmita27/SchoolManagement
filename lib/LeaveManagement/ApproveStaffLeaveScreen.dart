...
class ApproveStaffLeaveScreen extends StatefulWidget {
  @override
  _ApproveStaffLeaveScreenState createState() => _ApproveStaffLeaveScreenState();
}

class _ApproveStaffLeaveScreenState extends State<ApproveStaffLeaveScreen> {
  ...
  Future<void> _fetchLeaveList() async {
    final url = Uri.parse('http://localhost:3000/approve-staff-leave');
    try {
    ...
    return DataTable(
      ...
      rows: leaveList
        ...
        DataRow(cells: [
          ...
          DataCell(Text(leave['department'] ?? '')),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Approve Staff Leave List'),
