...
class _SignUpPageState extends State<SSignUpPage> {
  ...
  Future<void> _signUp() async {
    if (_formKey.currentState!.validate()) {
      ...
      final url = Uri.parse('http://localhost:3000/signup/student');
      try {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 250,
                      child: TextFormField(
                        decoration: InputDecoration(labelText: 'Section', labelStyle: TextStyle(color: Colors.white)),
                        style: TextStyle(color: Colors.white),
                        onSaved: (value) {
                          _section = value!;
                        },
                    ...
                    Container(
                      width: 250,
                      child: TextFormField(
                        decoration: InputDecoration(labelText: "Father's Name", labelStyle: TextStyle(color: Colors.white)),
                        style: TextStyle(color: Colors.white),
                        onSaved: (value) {
                          _fathersName = value!;
                        },
                    ...
                    Container(
                      width: 250,
                      child: TextFormField(
                        decoration: InputDecoration(labelText: 'Admission Number', labelStyle: TextStyle(color: Colors.white)),
                        style: TextStyle(color: Colors.white),
                        onSaved: (value) {
